...
FastBokeh::Context *m_FastBokehContext = nullptr;

m_FastBokehContext = FastBokeh::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

FastBokeh::OnNewFrame(FramesInFlight)
...
FastBokeh::DestroyContext(m_FastBokehContext);
...
FastBokeh::Context::s_techniqueLocation = L"./"
...
FastBokeh::Execute(m_FastBokeh, m_device, m_commandList);
...
FastBokeh::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

FastBokeh::Context::PerfEventBeginFn
FastBokeh::Context::PerfEventEndFn

=====================================================================================================
10) Optional: Hook up imgui for automatic UI of technique inputs
=====================================================================================================

if (m_FastBokeh && ImGui::CollapsingHeader("FastBokeh"))
    outline::MakeUI(m_FastBokeh);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("FastBokeh", FastBokeh::CreateModule);

in the python module, you will need to "import FastBokeh", and when will be able to set user exposed
variables like:

FastBokeh.Set_<variable name>(<value>);
