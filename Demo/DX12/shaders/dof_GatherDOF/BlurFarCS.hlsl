...
float2 ReadVec2STTexture(in uint3 pxAndFrame, in Texture2DArray<float2> tex)
{
	...
	if ((bool)_GatherDOF_BlurFarCSCB.JitterNoiseTextures)
...
void csmain(uint3 DTid : SV_DispatchThreadID)
{
	...
	uint noiseTextureFrameIndex = (bool)_GatherDOF_BlurFarCSCB.GatherDOF_AnimateNoiseTextures ? _GatherDOF_BlurFarCSCB.GatherDOF_FrameIndex : 0;
