...
float2 ReadVec2STTexture(in uint3 pxAndFrame, in Texture2DArray<float2> tex)
{
	...
	if (_GatherDOF_NearBlurCB.JitterNoiseTextures)
...
{
	if (!_GatherDOF_NearBlurCB.GatherDOF_UseNoiseTextures)
	{
...
void csmain(uint3 DTid : SV_DispatchThreadID)
{
	...
	uint noiseTextureFrameIndex = _GatherDOF_NearBlurCB.GatherDOF_AnimateNoiseTextures ? _GatherDOF_NearBlurCB.GatherDOF_FrameIndex : 0;
